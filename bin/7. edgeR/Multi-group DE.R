###This script should be ran from the /bin/ directory.
#Call out libaries. 
...
##Upload data
##Your working directory must be the /bin/ directory.
...
col.cell <- c("purple","orange","pink","red", "dark green", "blue")[sampleinfo$Histopatologic_group]
# Plot the heatmap using default edgeR configuration
...
write.csv(qlfCC$table, "../data/DEControlC-I.csv")
write.csv(qlfII$table, "../data/DEII-I.csv")
write.csv(qlfIII$table, "../data/DEControlIII-I.csv")
write.csv(qlfIV$table, "../data//DEIV-IV.csv")


####This tables will be the data we are going to use for the GSEA analysis.
